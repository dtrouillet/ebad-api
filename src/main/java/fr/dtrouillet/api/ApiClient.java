...
import fr.dtrouillet.api.auth.Authentication;
import fr.dtrouillet.api.auth.HttpBasicAuth;
import fr.dtrouillet.api.auth.ApiKeyAuth;
import fr.dtrouillet.api.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-07-11T21:08:45.148Z[GMT]")@Component("fr.dtrouillet.api.ApiClient")
public class ApiClient {
    ...
    private String basePath = "http://localhost:11006/ebad";
    ...
    authentications.put("ebad-api-key", new ApiKeyAuth("header", "ebad-api-key"));
